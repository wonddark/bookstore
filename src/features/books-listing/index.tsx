...
export default function BooksListing() {
  ...
  return (
    <div className="flex flex-col lg:flex-row flex-wrap gap-3 lg:gap-4 items-center lg:items-stretch justify-start lg:justify-center py-3 lg:py-4 px-3 lg:px-5">
      {isLoading &&
